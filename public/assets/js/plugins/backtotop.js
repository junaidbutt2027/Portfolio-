!(function (o) {
    ...
    o(document).ready(function () {
        var r = document.querySelector(".tmp-progress-parent path");
        if (!r) return;
        ...
        jQuery(window).on("scroll", function () {
            50 < jQuery(this).scrollTop()
                ? jQuery(".tmp-progress-parent").addClass("tmp-backto-top-active")
                : jQuery(".tmp-progress-parent").removeClass("tmp-backto-top-active");
        }),
            jQuery(".tmp-progress-parent").on("click", function (t) {
