 ...
 * -----------------------------------------------------------------------------
 *
 * Template : Personal Portfolio HTML Template
...
(function ($) {
  ...
  var invJs = {
    ...
    methods: function (e) {
      const fns = [
        ['preloaderActive', invJs.preloaderActive],
        ['textFooter', invJs.textFooter],
        ['imageAnimation', invJs.imageAnimation],
        ['clapAnimation', invJs.clapAnimation],
        ['titleAnim', invJs.titleAnim],
        ['gridMask', invJs.gridMask],
        ['smothScroll', invJs.smothScroll],
        ['lightBoxJs', invJs.lightBoxJs],
        ['swiperWidget', invJs.swiperWidget],
        ['WOW', invJs.WOW],
        ['counterUp', invJs.counterUp],
        ['typedActive', invJs.typedActive],
        ['menuCurrentLink', invJs.menuCurrentLink],
        ['stickyHeader', invJs.stickyHeader],
        ['popupMobileMenu', invJs.popupMobileMenu],
        ['onePageNav', invJs.onePageNav],
        ['rightDemo', invJs.rightDemo],
        ['tmpMouseMoveAnimation', invJs.tmpMouseMoveAnimation],
        ['tmpcustomAnimation', invJs.tmpcustomAnimation],
        ['uiUxSwiper', invJs.uiUxSwiper],
        ['positionStickyJs', invJs.positionStickyJs],
        ['dateUpdate', invJs.dateUpdate],
        ['stickyElements', invJs.stickyElements],
        ['videoActivation', invJs.videoActivation],
        ['animationOnHover', invJs.animationOnHover]
      ];
      for (const [name, fn] of fns) {
        try {
          ...
          console.warn(`Portfolio init failed for ${name}:`, err);
        }
      }
    },
    ...
    smothScroll: function () {
      $(document).on("click", ".smoth-animation, .scroll-down-section", function (event) {
        ...
        if (hashIdx !== -1) {
          ...
          if (normalizedPath === "" || normalizedPath === normalizedCurrent) {
            try {
              var target = $(hash);
              if (target.length) {
              ...
              console.warn("Invalid scroll target selector:", hash);
            }
          }
        } else {
          // If it's a simple selector, try to scroll
          try {
            var target = $(href);
            if (target.length) {
              event.preventDefault();
