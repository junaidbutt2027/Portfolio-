                              ...
                              <nav className="tmp-mainmenu-nav d-none d-xl-block tmp-on-hover-animation">
                                  <nav className="navbar-example2 onepagenav">
                                      <ul className="tmp-mainmenu nav nav-pills">
                                          ...
                                          <li className="current"><a className="smoth-animation" href="/developer#home">Home</a></li>
                                          <li><a className="smoth-animation" href="/developer#service">Services</a></li>
          ...
          <div className="tmp-popup-mobile-menu">
              <div className="inner">
                  ...
                  <ul className="tmp-mainmenu onepagenav-click">
                      <li><a href="/" className="external">Dashboard</a></li>
                      <li><a className="smoth-animation" href="/developer#home">Home</a></li>
                      <li><a className="smoth-animation" href="/developer#service">Services</a></li>
                      <li><a className="smoth-animation" href="/developer#portfolio">Portfolio</a></li>
                      <li><a className="smoth-animation" href="/developer#resume">Resume</a></li>
                      <li><a className="smoth-animation" href="/developer#pricing">Pricing</a></li>
                      <li><a className="smoth-animation" href="/developer#blog">Blog</a></li>
                      <li><a className="smoth-animation" href="/developer#contacts">Contact</a></li>
                  </ul>
              ...
              <div className="row">
                  <div className="content-wrapper hero-developer-portfolio">
                      ...
                      <div className="content">
                          ...
                          <a href="/developer#service" className="scroll-btn-wrap scroll-down-section mt-100">
                      ...
                      {testimonialsData.brands.map((brand, idx) => (
                          <div key={idx} className={`col-xl-3 col-lg-3 col-md-4 col-sm-6 tmp-scroll-trigger tmp-fade-in animation-order-${idx + 1}`}>
                              <div className="tmp-client-card text-center">
                                  <a href="/developer#" aria-label="client">
                                      <img src={brand} alt="" />
                                  </a>
                              </div>
                          </div>
                                      ...
                                      <div className="footer-bottom-area">
                                          <div className="top-nav-social-area-wrapper">
                                              <nav className="left-area">
                                                  <ul>
                                                      <li><a className="hover-moving-primary" href="/developer#">About us</a></li>
                                                      <li><a className="hover-moving-primary" href="/developer#">Discover</a></li>
                                                      <li><a className="hover-moving-primary" href="/developer#">Explore</a></li>
                                                      <li><a className="hover-moving-primary" href="/developer#">Books</a></li>
                                                  </ul>
                                              </nav>
                                              <div className="right-social-footer">
                                                  <ul>
                                                      <li><a href="/developer#"><i className="fa-brands fa-facebook-f"></i></a></li>
                                                      <li><a href="/developer#"><i className="fa-brands fa-twitter"></i></a></li>
                                                      <li><a href="/developer#"><i className="fa-brands fa-tiktok"></i></a></li>
                                                      <li><a href="/developer#"><i className="fa-brands fa-youtube"></i></a></li>
                                                  </ul>
                                              </div>
                                          </div>
                                          <div className="bottom-footer-area">
                                              <p>© <span id="year" suppressHydrationWarning={true}>{new Date().getFullYear()}</span> <a className="hover-moving-primary" href="/developer#">{heroData.name}</a> All rights reserved.</p>
                                              <div className="logo">
                                                  <a href="/">
                                                      <img className="logo-dark" src="/assets/images/logo/main-logo.svg" alt="logo" />
                                                      <img className="logo-white" src="/assets/images/logo/main-logo.svg" alt="logo" />
                                              ...
                                              <div className="small-nav">
                                                  <ul>
                                                      <li><a className="hover-moving-primary" href="/developer#">Terms of Service</a></li>
                                                      <li><a className="hover-moving-primary" href="/developer#">Privacy Policy</a></li>
                                                  </ul>
                                              </div>
                                          </div>
                                      </div>
                  ...
                  <nav className="navigation-menu onepagenav">
                      <ul>
                          <li className="navigation-menu--item">
                              <a href="/developer#home" className="navigation-menu--item-link">Home</a>
                          </li>
                          <li className="navigation-menu--item">
                              <a href="/developer#service" className="navigation-menu--item-link">Services</a>
                          </li>
                          <li className="navigation-menu--item">
                              <a href="/developer#portfolio" className="navigation-menu--item-link">Portfolio</a>
                          </li>
                          <li className="navigation-menu--item">
                              <a href="/developer#skill" className="navigation-menu--item-link">My Skill</a>
                          </li>
                          <li className="navigation-menu--item">
                              <a href="/developer#review" className="navigation-menu--item-link">Testimonial</a>
                          </li>
                          <li className="navigation-menu--item">
                              <a href="/developer#blog" className="navigation-menu--item-link">blog</a>
                          </li>
                          <li className="navigation-menu--item">
                              <a href="/developer#contact" className="navigation-menu--item-link">Contact</a>
                          </li>
                      </ul>
                  </nav>
              </div>
              <div className="tmp-header-hiring mt-5">
                  <a href="/developer#" className="tmp-header-hiring-link w-100 text-center">Lets Talk </a>
                  <a href="/developer#" className="tmp-header-hiring-link w-100 text-center">Buy Now </a>
              </div>
          </div>
      </div>
      {/* offcanvase end */}
